...
/* FIXME Timer/RCC Interaction is not implemented */
#if 0
 ...
 *
 ******************************************************************************/
template<intptr_t TimerT, typename RccT = stm32::Rcc>
...
public:
    ...
    void setOutputPin(gpio::GpioPin &p_pin) const {
        /* FIXME Setting the Timer Output to a GPIO no longer works */
        // p_pin.enable(stm32::GpioEngine::e_Alternate, stm32::GpioEngine::e_None, TimerViaSTM32F4FunctionHelper<TimerT>::m_gpio);
        p_pin.enable();
    }
...
public:
    TimerViaSTM32F4T(stm32::Rcc &p_rcc)

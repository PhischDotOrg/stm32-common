...
if ((NOT DEFINED OPENOCD_BIN) OR ("${OPENOCD_BIN}" STREQUAL "OPENOCD_BIN-NOTFOUND"))
	...
	if (NOT EXISTS ${OPENOCD_BOARD_CFG_DIR}/${OPENOCD_BOARD_CFG})
		message(WARNING "OpenOCD Board Configuration File \"${OPENOCD_BOARD_CFG_DIR}/${OPENOCD_BOARD_CFG}\" "
		"does not exist! OpenOCD may not work.")
	else()
		message("Using OpenOCD Configuration File ${OPENOCD_BOARD_CFG_DIR}/${OPENOCD_BOARD_CFG}")
	endif()
endif()
...
add_custom_target(flash
    ${OPENOCD_BIN} -f ${OPENOCD_BOARD_CFG_DIR}/${OPENOCD_BOARD_CFG} -c "program ${TARGET_ELF} verify reset exit"
    DEPENDS ${TARGET_ELF}
...
add_custom_target(gdbserver
    ${OPENOCD_BIN} -f ${OPENOCD_BOARD_CFG_DIR}/${OPENOCD_BOARD_CFG} -c "gdb_port 4242" -c "telnet_port 4444"
    DEPENDS ${TARGET_ELF}
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
